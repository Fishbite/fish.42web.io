$servername = 'sql206.infinityfree.com';$username = 'if0_36002208';$password = '2Aw73o2TsIW';$dbname = 'if0_36002208_test';$port = '3306';$conn = new mysqli($servername, $username, $password, $dbname, $port);
